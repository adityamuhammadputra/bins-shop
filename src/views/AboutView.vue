<template>
    <div class="section pt-2 mb-5" :class="(isMobile() ? '' : 'mt-5')">
        <div class="container">
            <div class="row mb-n6">
                <div class="col-lg-6 mb-6 aos-init aos-animate" data-aos="fade-right" data-aos-delay="600">
                    <div class="about_content">
                        ...
                        <p>Ya, sudah terjual ribuan di Tokopedia dan Shoope dengan berbagai ulasan Positif, tapi apa daya namanya dalam dunia bisnis ada saja kendala dan itu menjadi alasan kami kenapa harus membuat BinsShop.tech </p>
                        <p>Bisa kamu lihat, digambar penjualan dan ulasan kami sebelumnya :)</p>
                    </div>
                </div>
                <div class="col-lg-6 mb-6 aos-init aos-animate" data-aos="fade-left" data-aos-delay="600">
                    <div class="about_thumb">
                        <img class="fit-image" src="/assets/images/ulasan-1-toped.PNG" alt="About Image">
                        <img class="fit-image" src="/assets/images/ulasan-1-sopi.PNG" alt="About Image">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section section-margin mt-0">
        <div class="container">
            <h2 class="title text-center mb-5 pt-5" :class="(isMobile() ? '' : 'pb-4')">Ulasan di Tokopedia  dan Shopee</h2>
            <p></p>
            <div class="row mb-n6 pt-2">
                <Carousel :autoplay="5000" :wrap-around="true" :items-to-show="(isMobile()) ? 1 : 1" class="p-0-mobile">
                    <Slide v-for="slide in 10" :key="slide">
                        <div class="carousel__item">
                            <div class="banner">
                                <div class="banner-image">
                                    <a href=""><img :src="'/assets/images/ulasan-' + slide + '.PNG'" alt=""></a>
                                </div>
                                <!-- <div class="info">
